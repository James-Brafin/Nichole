...
{
    internal class EnemyEnhancement : Card, NicholeCard
    {
        public static void Register(IModHelper helper)
        {
            helper.Content.Cards.RegisterCard("EnemyEnhancement", new()
            {
                ...
                Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "EnemyEnhancement", "name"]).Localize
            });
        }
