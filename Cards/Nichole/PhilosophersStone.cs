...
{
    internal class PhilosophersStone : Card, NicholeCard
    {
        public static void Register(IModHelper helper)
        {
            helper.Content.Cards.RegisterCard("PhilosophersStone", new()
            {
                ...
                Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "PhilosophersStone", "name"]).Localize
            });
        }
