...
{
    internal class IgnitionStrike : Card, NicholeCard
    {
        public static void Register(IModHelper helper)
        {
            helper.Content.Cards.RegisterCard("IgnitionStrike", new()
            {
                ...
                Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "IgnitionStrike", "name"]).Localize
            });
        }
