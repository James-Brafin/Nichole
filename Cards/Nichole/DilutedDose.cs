...
{
    internal class DilutedDose : Card, NicholeCard
    {
        public static void Register(IModHelper helper)
        {
            helper.Content.Cards.RegisterCard("DilutedDose", new()
            {
                ...
                Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "DilutedDose", "name"]).Localize
            });
        }
        ...
        public override List<CardAction> GetActions(State s, Combat c)
        {
            ...
            switch (upgrade)
            {
                    ...
                    List<CardAction> cardActionList1 = new List<CardAction>()
                {
                    new AStatus()
                    {
                        status = ModEntry.Instance.PotionSaver.Status,
                        statusAmount = 1,
                        targetPlayer = true
                    }
                };
