...
internal sealed class BottleOfRocks : Card, PotionCard
{
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("BottleOfRocks", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "BottleOfRocks", "name"]).Localize
        });
    }
