...
internal sealed class IronskinPotion : Card, PotionCard
{
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("IronskinPotion", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "IronskinPotion", "name"]).Localize
        });
    }
