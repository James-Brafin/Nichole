...
internal sealed class WeakeningQuaff : Card, PotionCard
{
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("WeakeningQuaff", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "WeakeningQuaff", "name"]).Localize
        });
    }
