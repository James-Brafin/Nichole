...
internal sealed class DraughtOfCommand : Card, PotionCard
{
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("DraughtOfCommand", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "DraughtOfCommand", "name"]).Localize
        });
    }
